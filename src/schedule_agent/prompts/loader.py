...
def _resolve_skill_path(skill_name: str, cli_dir_path: Optional[Path] = None) -> Optional[Path]:
...
def _load_skill_metadata(skill_name: str, cli_dir_path: Optional[Path] = None) -> Optional[str]:
    """
